...
* **Markup/Design**: LaTeX, Markdown/R Markdown, HTML/XML/XAML, CSS/SCSS/Bootstrap/Tailwind, UML, YAML, Quarto, AImarkdown, Typst, Figma/Canva
...
* **Audio**: Sonic Pi, SuperCollider, ChucK, JythonMusic, LilyPond, MuseScore, Sibelius, Ableton Live, Studio One, GarageBand, FL Studio, EarSketch, Soundtrap
* **.NET**: C#, F#, Q#, Visual Basic/VBA, ML.NET, LINQ, WFA/WFP/Blend
...
* **Game Development**: Godot/GDScript, Game Maker/GML, Unity, OpenGL/GLSL, SDL/PyGame/LÖVE, Processing
...
I've also contributed to the upcoming programming language [![Carbon](https://badgen.net/badge/color/Carbon/000000?label=)](https://github.com/carbon-language/carbon-lang/commits?author=danielathome19) and created [![CodingVoyage.com](https://badgen.net/badge/color/CodingVoyage.com/0d6efd?label=)](https://codingvoyage.com)!
